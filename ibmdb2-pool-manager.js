...
class Db2ConnectionPoolManager {
  ...
  getConnectionCounts() {
    ...
    try {
      usedCount = this.pool.usedPool[this.connString].length;
      availableCount = this.pool.availablePool[this.connString].length;
      totalCount = usedCount + availableCount;
      ...
      // Will return defaults (0 if pool is unavailable)
